    ...
    <>
      ...
      >{({
        ...
        <form onSubmit={handleSubmit}>
          <div className="w-full px-4 lg:mb-10">
            ...
            <h4 className="text-sm md:text-xl lg:text-2xl font-medium text-center text-text-primary-color">¡La comunidad puede ayudarte a recuperarla!</h4>
          </div>
          <div className="lg:flex ">
            <div className="lg:flex-auto lg:w-64 ">
              <ImageInput name="image" value={values.image} onChange={handleChange} handleImageChangeBase64={handleUploadImage} />
            </div>
            <div className="lg:flex-auto lg:w-60 flex flex-wrap justify-center items-center md:px-24">
              <p className="text-sm md:text-lg lg:text-xl  font-medium text-text-primary-color mb-4">Por lo que es necesario que proporciones los siguientes datos.</p>
              <PostTextInput
