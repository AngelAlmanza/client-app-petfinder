    ...
    <div className="w-100 my-4 md:px-24">
      {
        value.length > 0
          ? (
            <div
              className="w-full h-52 md:h-60 mb-2 bg-gray-400 rounded-2xl flex justify-center items-center cursor-pointer overflow-hidden"
          ...
          : (
            <div
              className="w-full h-52 md:h-60 mb-2 bg-gray-400 rounded-2xl flex justify-center items-center cursor-pointer"
              onClick={onImageClick}
            >
